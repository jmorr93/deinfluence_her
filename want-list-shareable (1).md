...
1. In your project folder, create this directory if it doesn't exist:
   ```
   .claude/commands/
   ```
2. Save this file as `want-list.md` inside that folder:
   ...
   ```
3. The filename becomes the command — `want-list.md` → `/want-list`
4. Open Claude Code from your project folder (`claude` or `claude --chrome`) and type `/want-list` to use it
